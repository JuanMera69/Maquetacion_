...
<body>
    <header>
        <nav class="main-menu">
            <ul>
                <li class="logo"><img src="{{ asset('img/logo.png') }}" alt="Accedo"></li>
        ...
        <div class="extra-options">
            <button class="registro-btn"><strong>Registro</strong></button>
    ...
    <main class="main-content">
        ...
        <div class="content-right">
            <img src="{{ asset('img/Imagen banner Principal.webp') }}" alt="Banner">
        </div>
    </main>
                ...
                <div class="slide-content">
                    ...
                    <div class="image-text-group">
                        <div class="image-left">
                            <img src="{{ asset('img/Imagenes Carrusel 1.webp') }}" alt="carrusel">
                        </div>
                        <div class="text-right">
                            <p><span class="highlight"><strong>Creación y gestión de <br> cursos
                                        personalizados</strong></span></p>
    ...
    <section class="info-section">
        <p class="info-text">Levely ofrece soluciones completas para empresas e instituciones educativas que <br> desean
            gestionar programas de formación en línea eficientemente.</p>
        <div class="info-content">
            ...
            <div class="cards-container">
                <div class="card">
                    ...
                    <hr class="rojo">
                    <p class="card-text">
                        Nuestros especialistas diseñan e <br> implementan soluciones adaptadas a <br> las necesidades
                        específicas de cada <br> cliente.
                    </p>
                </div>
                ...
                <div class="card">
                    ...
                    <hr class="azul">
                    <p class="card-text">
                        Ofrecemos capacitación para <br> administradores y usuarios, además <br> de soporte técnico
                        continuo para <br> una experiencia sin problemas.
                    </p>
                </div>
                ...
                <div class="card">
                    ...
                    <hr class="verde">
                    <p class="card-text">
                        Mantenemos nuestra plataforma <br> actualizada con las últimas mejoras, <br> asegurando acceso a
                        la tecnología <br> más avanzada.
                    </p>
                </div>
                ...
                <div class="card">
                    ...
                    <hr class="amarillo">
                    <p class="card-text">
                        Permite a las empresas publicar y <br> monetizar sus cursos en nuestra <br> plataforma MOOC,
                        ampliando su <br> alcance a otros usuarios y empresas.
                    </p>
                </div>
            </div>
        </div>
        ...
        <p class="extra-info-text">
            Con Levely, las empresas e instituciones educativas maximizan el aprendizaje en línea <br> para mejorar el
        ...
        <div class="card extra-card1">
            <div class="gray-bg1">
                <img src="{{ asset('img/Iconos Carrusel beneficios 1.webp') }}" alt="Icono pequeño"
                    class="small-icon1">
                <div class="card-content1">
                    <p class="parrafo-carta1"><strong>Actualizarse en el mundo laboral y/o <br> académico.</strong></p>
                    <p class="parrafo-cartas1">
                        Podrán aprender cómo superar esos primeros obstáculos para involucrarse en el mundo laboral, y
                        prepararse mejor para sus primeros meses en la universidad.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="card extra-card">
            <div class="gray-bg">
                <img src="{{ asset('img/Iconos Carrusel beneficios 2.webp') }}" alt="Icono pequeño"
                    class="small-icon2">
                <div class="card-content">
                    <p class="parrafo-carta"><strong>Enfocarse en conocimientos específicos</strong></p>
                    <p class="parrafo-cartas">
                        Mediante nuestro sistema de seguimiento, tus estudiantes podrán medir <br> qué tanto han
                        aprendido usando nuestros contenidos y nuestra tecnología.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="card extra-card">
            <div class="gray-bg">
                <img src="{{ asset('img/Iconos Carrusel beneficios 3.webp') }}" alt="Icono pequeño"
                    class="small-icon2">
                <div class="card-content">
                    <p class="parrafo-carta"><strong>Enfocarse en conocimientos específicos</strong></p>
                    <p class="parrafo-cartas">
                        De la mano de los maestros, tus estudiantes podrán potenciar nuevas habilidades para su futuro
                        profesional.
                    </p>
                </div>
            </div>
        ...
        <div class="extra-image">
            <img src="{{ asset('img/Imagenes Carrusel 2.webp') }}" alt="Imagen mediana">
        </div>

        <div class="extra-small-image">
            <img src="{{ asset('img/Vectores seccion Carrusel beneficios.webp') }}" alt="Imagen pequeña">
        </div>
    </section>
    ...
    <footer class="site-footer">
        <div class="footer-content">
            ...
            <div class="footer-text">
                <p>Producto de Panthera © 2024</p>
            </div>
        </div>
    </footer>

    <script src="{{ asset('js/carrusel_imagenes.js') }}"></script>
</body>
